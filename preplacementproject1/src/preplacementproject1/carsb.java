...
public class carsb {
	...
	int bf;
	int gf;
	// total var for coubt the total price
	int total=0;
	// getting the information from user which service he want then store into the string object
	...
	carsb(int bs,int ef,int cf,int bf,int gf)
	{
		this.bs=bs;
		this.ef=ef;
		this.cf=cf;
	...
	public void enters()
	{
		...
		for(int j=0;j<n;j++)
		{
			// assign the services from string to temp var and checking each with services availble
			String tem=sr[j];
